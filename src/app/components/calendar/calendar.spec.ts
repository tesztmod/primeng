...
describe("Calendar", () => {
    ...
    it("should show icon", () => {
        ...
        expect(calenderEl.nativeElement.className).toContain(
            "p-calendar-w-btn"
        );
    ...
    it("should show panel", () => {
        ...
        const panelEl = fixture.debugElement.query(By.css("div"));
        expect(panelEl).toBeTruthy();
        expect(panelEl.nativeElement.className).toContain(
            "p-datepicker-inline"
        );
    });
    ...
    it("should select next month and call navForward", () => {
        ...
        const nextMonthEl = fixture.debugElement.query(
            By.css(".p-datepicker-next")
        );
        nextMonthEl.nativeElement.click();
        fixture.detectChanges();

        const currentMonthEl = fixture.debugElement.query(
            By.css(".p-datepicker-month")
        );
    ...
    it("should select pre month and call navBackward", () => {
        ...
        const preMonthEl = fixture.debugElement.query(
            By.css(".p-datepicker-prev")
        );
    ...
    it("should select date when click", fakeAsync(() => {
        ...
        const onDateSelectSpy = spyOn(
            calendar,
            "onDateSelect"
        ).and.callThrough();
        const calendarContainer = fixture.debugElement.query(
            By.css(".p-datepicker-calendar-container")
        );
        const sampleDateEls = calendarContainer
            .query(By.css("tbody"))
            .queryAll(
                By.css("span:not(.p-datepicker-weeknumber):not(.p-disabled)")
            );
        expect(calendar.dateTemplate).toBeFalsy();
        sampleDateEls[7].nativeElement.click();
        fixture.detectChanges();

        const datesEl = calendarContainer
            .query(By.css("tbody"))
            .queryAll(
                By.css("span:not(.p-datepicker-weeknumber):not(.p-disabled)")
            );
        ...
        for (let x = 0; x < datesEl.length; x++) {
            if (x == 7)
                expect(datesEl[x].nativeElement.className).toContain(
                    "p-highlight"
                );
            else
                expect(datesEl[x].nativeElement.className).not.toContain(
                    "p-highlight"
                );
        }
    ...
    it("should change date format", () => {
        ...
        if (calendar.currentMonth < 9)
            expect(calendar.inputFieldValue).toEqual(
                "08/0" +
            ...
            expect(calendar.inputFieldValue).toEqual(
                "08/" + (calendar.currentMonth + 1) + "/" + calendar.currentYear
            );
        expect(onDateSelectSpy).toHaveBeenCalled();
    });
    ...
    it("should use invalidDates", () => {
        ...
        for (let el of unselectableEls) {
            if (
                el.nativeElement.textContent == invalidDate.getDate() ||
                el.nativeElement.textContent == invalidDate2.getDate()
            ) {
    ...
    it("should show time", () => {
        ...
        calendar.defaultDate = date;
        jasmine.clock().mockDate(date);
        const updateInputfieldSpy = spyOn(
            calendar,
            "updateInputfield"
        ).and.callThrough();
        ...
        const incrementHourSpy = spyOn(
            calendar,
            "incrementHour"
        ).and.callThrough();
        const decrementHourSpy = spyOn(
            calendar,
            "decrementHour"
        ).and.callThrough();
        const incrementMinuteSpy = spyOn(
            calendar,
            "incrementMinute"
        ).and.callThrough();
        const decrementMinuteSpy = spyOn(
            calendar,
            "decrementMinute"
        ).and.callThrough();
        const navigators = fixture.debugElement
            .query(By.css(".p-datepicker-title"))
            .queryAll(By.css("select"));
        const timers = fixture.debugElement
            .query(By.css(".p-timepicker"))
            .queryAll(By.css("div"));
        ...
        expect(
            hourPicker.queryAll(By.css("span"))[1].nativeElement.textContent
        ).not.toEqual(defaultHour.toString());
        expect(
            minutePicker.queryAll(By.css("span"))[1].nativeElement.textContent
        ).not.toEqual(defaultMinute.toString());
        expect(
            hourPicker.queryAll(By.css("span"))[1].nativeElement.textContent
        ).toEqual(calendar.currentHour.toString());
        expect(
            minutePicker.queryAll(By.css("span"))[1].nativeElement.textContent
        ).toEqual(calendar.currentMinute.toString());
        expect(calendar.currentMinute).toEqual(13);
        expect(calendar.currentHour).toEqual(16);
        const datesContainer = fixture.debugElement.query(
            By.css(".p-datepicker-calendar-container")
        );
        const dates = datesContainer
            .query(By.css("tbody"))
            .queryAll(
                By.css("span:not(.p-datepicker-weeknumber):not(.p-disabled)")
            );
        ...
        ).toEqual(calendar.inputFieldValue);
    });
    ...
    it("should only time", () => {
        ...
        expect(
            hourPicker.queryAll(By.css("span"))[1].nativeElement.textContent
        ).toContain(calendar.currentHour.toString());
        expect(
            minutePicker.queryAll(By.css("span"))[1].nativeElement.textContent
        ).toContain(calendar.currentMinute.toString());
        expect(
            fixture.debugElement.query(By.css("input")).nativeElement.value
        ).toEqual(calendar.inputFieldValue);
    });
    ...
    it("should select today and clear input with button bar", fakeAsync(() => {
        ...
        const onClearButtonClickSpy = spyOn(
            calendar,
            "onClearButtonClick"
        ).and.callThrough();
        const onTodayButtonClickSpy = spyOn(
            calendar,
            "onTodayButtonClick"
        ).and.callThrough();
        const buttonbar = fixture.debugElement.query(
            By.css(".p-datepicker-buttonbar")
        );
    ...
    it("should change today & clear button styleClass", () => {
        ...
        const todayButtonEl = buttonbar.queryAll(By.css("button"))[0];
        const clearButtonEl = buttonbar.queryAll(By.css("button"))[1];
        expect(todayButtonEl.nativeElement.className).toContain(
            "Primeng ROCKS!"
        );
        expect(clearButtonEl.nativeElement.className).toContain(
            "Primeng ROCKS!"
        );
    });
    ...
    it("should show month picker", fakeAsync(() => {
        ...
        const onMonthSelectSpy = spyOn(
            calendar,
            "onMonthSelect"
        ).and.callThrough();
        const panelEl = fixture.debugElement.query(By.css("div")).nativeElement;
        const monthpickerEl = fixture.debugElement.query(
            By.css(".p-monthpicker")
        );
    ...
    it("should use touchUI", fakeAsync(() => {
        ...
        const onOverlayAnimationStartSpy = spyOn(
            calendar,
        ...
        if (calendar.currentMonth < 9)
            ...
            expect(calendar.inputFieldValue).toEqual(
                calendar.currentMonth + 1 + "/01/" + calendar.currentYear
            );
        expect(inputEl.value).toEqual(calendar.inputFieldValue);
        expect(onDateSelectSpy).toHaveBeenCalled();
    ...
    it("should select date with keyboardEvent", () => {
        ...
        const monthSpanEl = fixture.debugElement.query(
            By.css(".p-datepicker-month")
        ).nativeElement;
        const yearSpanEl = fixture.debugElement.query(
            By.css(".p-datepicker-year")
        ).nativeElement;
    ...
    it("should listen onMonthChange", () => {
        ...
        calendar.onMonthChange.subscribe(
            (value) => (onMonthChangeValue = value)
        );
        const inputEl = fixture.debugElement.query(
            By.css("input")
        ).nativeElement;
    ...
    it("should show hourFormat", () => {
        ...
        const minutePicker = fixture.debugElement.query(
            By.css(".p-minute-picker")
        );
    ...
    it("should set defaultDate", () => {
        ...
        const monthEl = fixture.debugElement.query(
            By.css(".p-datepicker-month")
        );
        expect(
            hourPicker.queryAll(By.css("span"))[1].nativeElement.textContent
    ...
    it("should show seconds", () => {
        ...
        const seperatorEl = fixture.debugElement.queryAll(
            By.css(".p-separator")
        );
        const secondPicker = fixture.debugElement.query(
            By.css(".p-second-picker")
        );
        ...
        expect(
            secondPicker.queryAll(By.css("span"))[1].nativeElement.textContent
        ).toEqual("21");
    });
    ...
    it("should change seconds", () => {
        ...
        const incrementSecondSpy = spyOn(
            calendar,
            "incrementSecond"
        ).and.callThrough();
        const decrementSecondSpy = spyOn(
            calendar,
            "decrementSecond"
        ).and.callThrough();
        const inputEl = fixture.debugElement.query(By.css(".p-inputtext"));
    ...
    it("should disabled(inline true)", () => {
        ...
        const incrementYearSpy = spyOn(
            calendar,
            "incrementYear"
        ).and.callThrough();
        const decrementYearSpy = spyOn(
            calendar,
            "decrementYear"
        ).and.callThrough();
        const createMonthsSpy = spyOn(
            calendar,
            "createMonths"
        ).and.callThrough();
        const preMonthEl = fixture.debugElement.query(
    ...
    it("should change showOtherMonths", () => {
        ...
        const otherMonthDates = datesContainer.queryAll(
            By.css(".p-datepicker-other-month")
        );
    ...
    it("should be previous year", () => {
        ...
        const navBackwardSpy = spyOn(calendar, "navBackward").and.callThrough();
        const prevMonthEl = fixture.debugElement.query(
            By.css(".p-datepicker-prev")
        );
    ...
    it("should use Year Picker", () => {
        ...
        const yearSelectEl = fixture.debugElement.query(
            By.css(".p-yearpicker")
        );
    ...
    it("should call navForward and pick the next year", () => {
        ...
        const navForwardEl = fixture.debugElement.query(
            By.css(".p-datepicker-next")
        );
        const navBackwardEl = fixture.debugElement.query(
            By.css(".p-datepicker-prev")
        );
    ...
    it("should call navForward and go to out of year range(increment)", () => {
        ...
        calendar.view = "month";
        calendar.yearRange =
            (calendar.currentYear - 1).toString() +
            ":" +
            (calendar.currentYear + 1).toString();
        calendar.yearNavigator = true;
        ...
        const populateYearOptionsSpy = spyOn(
            calendar,
            "populateYearOptions"
        ).and.callThrough();
    ...
    it("should select time with keyboardEvent", () => {
        ...
        const parseValueFromStringSpy = spyOn(
            calendar,
    ...
    describe("ngAfterContentInit", () => {
        ...
        it("should set dateTemplate if the type is anything else", () => {
            const template = TemplateRef.prototype;
            calendar.templates = [
                { template, getType: () => "anything else" },
            ] as unknown as QueryList<any>;
    ...
    describe("onContainerButtonKeydown", () => {
        it("should call trapFocus if which is 9", () => {
            calendar.inline = false;
            const trapFocusSpy = spyOn(calendar, "trapFocus");

            calendar.onContainerButtonKeydown({ which: 9 });

            expect(trapFocusSpy).toHaveBeenCalled();
        });

        it("should set overlayVisible to false if which is 27", () => {
            calendar.overlayVisible = true;

            calendar.onContainerButtonKeydown({
                which: 27,
                preventDefault: () => {},
            });
        ...
        it("should not do any ot that if which is something different number", () => {
            calendar.overlayVisible = true;
            const trapFocusSpy = spyOn(calendar, "trapFocus");
            ...
            expect(calendar.overlayVisible).toBeTrue();
        });
    });

    describe("onDateCellKeydown", () => {
        it("should set backward to false if which is 40 and it has class", () => {
            const mockEvent = {
                preventDefault: () => {},
                currentTarget: {
                    parentElement: {
            ...
            spyOn(DomHandler, "index").and.returnValue(0);
            spyOn(DomHandler, "hasClass").and.returnValue(true);

            calendar.onDateCellKeydown(mockEvent, new Date(), 1);

            expect(calendar.navigationState).toEqual({ backward: false });
        });

        it("should set tabIndex to 0 if which is 40 and it don't have class", () => {
            const mockEvent = {
                preventDefault: () => {},
                currentTarget: {
                    parentElement: {
            ...
            expect(
                mockEvent.currentTarget.parentElement.parentElement
                    .nextElementSibling.children[0].children[0].tabIndex
            ).toBe("0");
        });

        it("should set backward to false if which is 40 and nextElementSibling does not exists", () => {
            const mockEvent = {
                preventDefault: () => {},
                currentTarget: {
                    parentElement: {
        ...
        it("should set backward to false if it has class and which is 38", () => {
            const mockEvent = {
                preventDefault: () => {},
                currentTarget: {
                    parentElement: {
            ...
            expect(calendar.navigationState).toEqual({ backward: true });
        });

        it("should set tabIndex to 0 if it does not have class which is 38", () => {
            const mockEvent = {
                preventDefault: () => {},
                currentTarget: {
                    parentElement: {
            ...
            expect(
                mockEvent.currentTarget.parentElement.parentElement
                    .previousElementSibling.children[0].children[0].tabIndex
            ).toBe("0");
        });
        it("should set backward to true if previousElementSibling does not exists", () => {
            const mockEvent = {
                preventDefault: () => {},
                currentTarget: {
                    parentElement: {
        ...
        it("should call navigateToMonth if which is 37 and has class", () => {
            const mockEvent = {
                preventDefault: () => {},
                currentTarget: {
                    parentElement: {
                        previousElementSibling: {
                            children: [{ parentElement: undefined }],
                        },
                    },
                },
                which: 37,
            ...
            spyOn(DomHandler, "hasClass").and.returnValues(false, true);
            const navigateToMonthSpy = spyOn(calendar, "navigateToMonth");

            calendar.onDateCellKeydown(mockEvent, new Date(), 1);

            expect(navigateToMonthSpy).toHaveBeenCalled();
        });

        it("should set tabIndex to 0 if which is 37 and does not have class", () => {
            const mockEvent = {
                preventDefault: () => {},
                currentTarget: {
                    parentElement: {
                        previousElementSibling: {
                            children: [{ tabIndex: "-1", focus: () => {} }],
                        },
                    },
                },
                which: 37,
            ...
            expect(
                mockEvent.currentTarget.parentElement.previousElementSibling
                    .children[0].tabIndex
            ).toBe("0");
        });

        it("should call navigateToMonth if which is 37 and previousElementSibling does not exists", () => {
            const mockEvent = {
                preventDefault: () => {},
                currentTarget: {
                    parentElement: {
        ...
        it("should call navigateToMonth if it has class and which is 39", () => {
            const mockEvent = {
                preventDefault: () => {},
                currentTarget: {
                    parentElement: {
        ...
        it("should set tabIndex to 0 if it does not have class and which is 39", () => {
            const mockEvent = {
                preventDefault: () => {},
                currentTarget: {
                    parentElement: {
            ...
            expect(
                mockEvent.currentTarget.parentElement.nextElementSibling
                    .children[0].tabIndex
            ).toBe("0");
        });

        it("should call navigateToMonth if which is 39 and nextElementSibling does not exists", () => {
            const mockEvent = {
                preventDefault: () => {},
                currentTarget: {
                    parentElement: {
        ...
        it("should call onDateSelect if which is 13", () => {
            const mockEvent = {
                preventDefault: () => {},
        ...
        it("should call onDate select if which is 32", () => {
            const mockEvent = {
                preventDefault: () => {},
                currentTarget: { parentElement: {} },
                which: 32,
        ...
        it("should set overlayVisible if which is 27", () => {
            const mockEvent = {
                preventDefault: () => {},
                currentTarget: { parentElement: {} },
                which: 27,
        ...
        it("should not do anything if which is any other number", () => {
            const mockEvent = {
                preventDefault: () => {},
                currentTarget: { parentElement: {} },
                which: -1,
            ...
            expect(trapFocusSpy).not.toHaveBeenCalled();
            expect(navigateToMonthSpy).not.toHaveBeenCalled();
            expect(calendar.overlayVisible).toBe(undefined);
        });
    });
});
